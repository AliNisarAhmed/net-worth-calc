...
import { convertLineItem, currencyMap, getNumberWithScale } from "./";
...
describe("Test Line Item conversion", () => {
  test("Convert from USD to CAD", () => {
    ...
    const res1 = convertLineItem(i1, { scaledRate, newCurrency, oldCurrency });
    const res2 = convertLineItem(i2, { scaledRate, newCurrency, oldCurrency });
    const res3 = convertLineItem(i3, { scaledRate, newCurrency, oldCurrency });
  ...
  test("Test: Convert CNY to USD", () => {
    ...
    const res1 = convertLineItem(i1, { scaledRate, oldCurrency, newCurrency });
